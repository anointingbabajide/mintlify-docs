---
title: "How Perpetra Works: Architecture Overview (End to End)"
...
<CardGroup cols={2}>
  ...
  <Card title="Liquidation Engine" icon="triangle-exclamation" href="/architecture/liquidation-engine">
    See how underwater positions are closed out and how the keeper fee is settled.
  </Card>
  <Card title="Points & Referrals" icon="trophy" href="/architecture/points">
    Learn how trading and deposit activity is tracked for future rewards.
  </Card>
</CardGroup>
