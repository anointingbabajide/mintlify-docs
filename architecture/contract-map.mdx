---
title: "Perpetra Contract Map: Every Piece Explained"
sidebarTitle: "Contract Map"
description: "A plain-language guide to what each Perpetra contract does and how they connect — organized by function, not by name."
---
...
<Note>
  All live contract addresses for Hedera mainnet and testnet are listed in [Contract Addresses](/reference/contract-addresses).
</Note>
